          ...
          {[
            ...
            return (
              <button
                ...
                className={`pl pl-interactive wizard-choice-tile p-3.5 rounded-2xl text-center flex flex-col items-center justify-center gap-1.5 cursor-pointer min-h-[120px] relative ${isActive
